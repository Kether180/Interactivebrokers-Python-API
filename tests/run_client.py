...
# Master Account #: DU5001780 Username: btrad5149 Password: test1234
...
#   account_id=REGULAR_ACCOUNT, # Changed paper_account
#  page_id=0
# )
...
aapl_quote_fields = [55, 7296, 7295, 86, 70, 71, 84, 31]
aapl_current_prices = ib_client.market_data(
    conids=['265598'],
    since='0',
    fields=aapl_quote_fields
)
pprint(aapl_current_prices)
pprint('')

# Grab the quarterly income statement - ib_cloent.
